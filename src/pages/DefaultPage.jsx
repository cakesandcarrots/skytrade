    ...
    <>
      <div class="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
          <p class="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-indigo-300 mt-2">
            Page Not Found
          </p>
          ...
          <Link to="/"
            class="flex items-center space-x-2 bg-indigo-600 hover:bg-indigo-700 text-gray-100 px-4 py-2 rounded transition duration-150"
            title="Return Home"
          >
            <svg
